...
<%@ page import="java.util.Locale,java.text.NumberFormat"%>
	...
	<nav class="navbar navbar-expand-lg navbar-light"
		style="position: fixed; z-index: 4; top: 125px;
	/* border-radius: 18px; */ padding: inherit;"
		id="menu-2">
		<button class="navbar-toggler" type="button" data-toggle="collapse"
			data-target="#button-left" aria-controls="button-left"
			aria-expanded="false" aria-label="Toggle navigation">
			<span class="navbar-toggler-icon"></span> <span>ARRANGE</span>
	...
	<section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
		<div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
			<h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3"
				style="font-family: bungee">THE HANDIER</h3>

			<div class="row">
   <input type="hidden" name="category" value="${danhmuc }">
				<div class="row"
					style="margin-right: 5px; position: absolute; width: 167px; right: 0;top: 406px" id="button-product"> 
					<button class="btn btn-prime col-12" id="button-collapse"
						style="z-index: 3;">
						<span>ARRANGE</span>
					</button>
					<div class="side-bar col-12" id="button-left3"
						style="display: none; z-index: 2; background: rgba(239, 239, 239, 0.73);">
								...
								<div class="product-toys-info wow zoomIn">
									<div class="men-pro-item">
										<div class="men-thumb-item">
											<img
												src="blank.gif" data-src='<c:url value="/resource/images/${sanpham.getHinhsanpham()}"/>'
				...
				<div class="container-fluid" id="pagination_bar"
					style="position: fixed; bottom: 0; right: 84px; z-index: 999;">
					<div class="row float-right">
						<nav aria-label="Page navigation example" class="col" id="slmax"
							data-max="${tongsotrang}">
							<ul class="pagination">
								<li class="page-item">
								<div class="page-link1 page-link"
										aria-label="Previous">
